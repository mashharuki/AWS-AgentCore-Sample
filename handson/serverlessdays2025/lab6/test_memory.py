...
lab6は、AWSコスト見積もりエージェントに短期・長期メモリ機能を追加するAgentWithMemoryクラスの実装です。
このモジュールは、コンテキストを認識し、ユーザーの好みを学習できるエージェントを作成します
"""
...
class AgentWithMemory:
    ...
    def propose(self, requirements: str) -> str:
        ...
        長期メモリのユーザー好みに基づいて最適なアーキテクチャを提案
        """
        try:
